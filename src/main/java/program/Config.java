...
public class Config {
    public static final String SEND_SUCCESS = "Send mail success!";

    //config server
    public static  final String PROTOCOL_IMAP = "imap";
    public static  final String HOST_IMAP = "imap.gmail.com";
    public static  final String PORT_IMAP = "993";
    ...
    public static final String TOPIC_SEND = "Warning";
    public static final String RESULT = "Result!";
    public static final String TOPIC_RECEIVE = "ITLAB-HOMEWORK";
    public static final String EXTENSION_JAVA = ".java";
    public static final String EXTENSION_ZIP = ".zip";
    public static final String FILE_JAVA = "Request to send 1 java file!";
    public static final String FILE_ZIP = "The file submitted must be a zip file";
    public static final String NOT_ATTACHMENT = "Your mail does not contain attachments!";
